...
public class Blackjack {
    ...
    public static void main(String[] args) {
       ...
       while(true){
        ...
        int newCrad= randomCard();
        total+=Math.min(newCrad,10);
        System.out.println("\nYou get a\n"+cardString(newCrad));
       ...
       while(dealerTotal<17){
        int newCrad=randomCard();
        dealerTotal+=Math.min(newCrad,10);
        System.out.println("\n Dealer gets a \n"+ cardString(newCrad));
    ...
    public static int randomCard(){
            double numberPicked=  Math.random()*13;
            numberPicked+=1;
            return (int) numberPicked;
    }
    ...
    public static String hitOrStay(){
        ...
        while(true){ if(response.equalsIgnoreCase("hit")|| response.equalsIgnoreCase("stay")){
            break;
        }
